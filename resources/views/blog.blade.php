...
@section('content')
        ...
        <section class="breadcrumb">
            <div class="container">
                <div class="row">
                    <div class="col-sm-7">
                        <h1 style="font-family: Moon">Blog</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="text-align: center;margin-bottom: 20px">
                        ...
                        SEAT hadir sebagai solusi dari permasalahan ini, dimana banyak dari kita yang merasa kecewa karena tidak mendapat tempat duduk pada restaurant favorit atau bahkan harus mencari tempat lain untuk memiliki quality time bersama teman dan keluarga, <br><br>
                        SEAT merupakan layanan berbasis web yang dapat digunakan sebagai media dalam melakukan pemesanan atau booking meja untuk restoran ataupun café yang dapat di akses secara mudah melalui genggaman, kapan saja, dimana saja.<br><br>
